...
public class RestBillDetail implements Serializable {
	...
	private float billDetailSubtotal;

	@Column(name="BILL_DETAIL_TOTAL")
	private float billDetailTotal;
	...
	public float getBillDetailSubtotal() {
		return this.billDetailSubtotal;
	}

	public void setBillDetailSubtotal(float billDetailSubtotal) {
		this.billDetailSubtotal = billDetailSubtotal;
	}

	public float getBillDetailTotal() {
		return this.billDetailTotal;
	}

	public void setBillDetailTotal(float billDetailTotal) {
